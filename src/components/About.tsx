    ...
    <section id="about" className="py-20">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          Hello! am a passionate full-stack developer & a 3rd year software engineering student at ISSATSO with a love for creating beautiful, functional, and
  ...
  return (
    <section id="about" className="py-20">
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-lg mb-4">
          Hello! I am a passionate full-stack developer & a 2nd year software engineering student at ISSATSO with a love for creating beautiful, functional, and
          user-friendly web applications and with a strong foundation in both front-end and back-end technologies</p>
<p className="text-lg mb-4">
  Always exploring new technologies, contributing to open source, and solving challenges over a good cup of coffee.
</p>
